...
Before building a character, it's important you get a basic understanding of the setting and tone of the world. First read the game's readme, then the overview of the starting location, by default [Paragon City](/Setting/The%20System/Human%20Commonwealth/Paragon&20City.md). Then browse through other lore documents until you feel you are ready. 
#### Step 1. Backgrounds
...
You may then buy up to two different Items from [Basic Items](/Reference/Items/Basic%20Items.md) page (and multiples if you like), and up to one weapon from the [Weapons](/Reference/Items/Weapons.md) page. Add these to the inventory section (p1, ↓), and also add the weapon to the items section (p2, |). For help with filling in the item boxes see [this section](/Mechanics/Combat.md#Weapons).
